<template>
    <div class="concrete-pillar-calc">
                    ...
                    <div class="section-content" :class="{ active: openedSections.climate }">
                        <div class="form-grid compact-grid">
                            <div class="form-group compact-group">
                                ...
                                <select v-model="formData.windRegion" class="form-control compact-input">
                            ...
                            <div class="form-group compact-group">
                                ...
                                <select v-model="formData.terrainType" class="form-control compact-input">
                            ...
                            <div class="form-group compact-group">
                                ...
                                <select v-model="formData.snowRegion" class="form-control compact-input">
                            ...
                            <div class="form-group compact-group">
                                ...
                                <select v-model="formData.iceRegion" class="form-control compact-input">
                    ...
                    <div class="section-content" :class="{ active: openedSections.materials }">
                        <div class="form-grid compact-grid">
                            <div class="form-group compact-group">
                                ...
                                <select v-model="formData.concreteClass" class="form-control compact-input">
                            ...
                            <div class="form-group compact-group">
                                ...
                                <select v-model="formData.reinforcementClass" class="form-control compact-input">
        ...
        <div class="calc-actions">
            ...
            <button @click="saveCalculation" class="btn btn-save" :disabled="isLoading">
                Сохранить расчет
            </button>
