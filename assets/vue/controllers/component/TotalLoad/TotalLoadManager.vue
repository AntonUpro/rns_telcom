 ...
 *         "totalLoad": 1520.5,       // Общая нагрузка, Н
 *         "loadPerLinearMeter": 506.8 // Нагрузка на 1 п.м., Н/м
 *       }
 *     ],
 ...
 *         "totalLoad": 840.0,       // Общая нагрузка, Н
 *         "loadPerLinearMeterPerBelt": 210.0 // Нагрузка на 1 п.м. 1 пояса, Н/м
 *       }
 *     ],
 ...
 *         "totalLoad": 2150.0       // Общая нагрузка на этой отметке, Н
 *       }
 *     ]
 *   }
 * }
                    ...
                    <table class="data-table">
                        <thead>
                            <tr>
                                ...
                                <th>Общая нагрузка,<br>Н</th>
                                <th>Нагрузка на 1<br>пог. метр, Н/м</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <table class="data-table">
                        <thead>
                            <tr>
                                ...
                                <th>Высота,<br>мм</th>
                                <th>Общая<br>нагрузка, Н</th>
                                <th>Нагрузка на 1 п.м.<br>1 пояса, Н/м</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr
                    ...
                    <table class="data-table">
                        <thead>
                            <tr>
                                ...
                                <th>Высота,<br>мм</th>
                                <th>Общая нагрузка<br>на отметке, Н</th>
                                <th class="col-input">Кол-во узлов<br>приложения силы</th>
                                <th>Нагрузка на<br>один узел, Н</th>
                            </tr>
                        </thead>
                        <tbody>
