...
final class InspectionProgramAppendix implements SectionBuilderInterface
{
    public function build(Section $section, ReportContext $context, int &$tableNum): void
    {
        ...
        $items = [
            '1. Выполнен сбор и анализ проектной, исполнительной и эксплуатационно-технической документации (при наличии).',
            '2. Рассмотрены фактические условия работы сооружения:',
        ];
        ...
        $section->addText(
            '3. Выполнены поверочные расчёты конструкций с учётом расчётных нагрузок, '
